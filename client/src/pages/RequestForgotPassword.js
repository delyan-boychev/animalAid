...
export default class RequestForgotPassword extends React.Component
{
    ...
    submitForm = async (event) =>
    {
      ...
      if(this.state.errors.isValid)
      {
          ...
          if(res === true)
          {
            this.openModal("Моля проверете имейл адреса си и отворете линка за смяна на паролата!");
          }
          else if(res === "TOO_EARLY")
          {
            this.openModal("Имате право да изпращате само по една заявка за забравена парола на 24 часа! Моля опитайте отново след 24 часа!");
          }
          else
          {
