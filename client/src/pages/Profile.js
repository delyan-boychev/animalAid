...
export default class Profile extends React.Component
{
    render()
    {
            ...
            <Tab eventKey="changeEmail" title={<p style={{fontSize: 17, fontWeight: "bold",}}><FontAwesomeIcon icon={faAt}></FontAwesomeIcon> Промяна на имейл адрес</p>}>
                <ChangeEmail></ChangeEmail>
            </Tab>
            <Tab eventKey="changePassword" title={<p style={{fontSize: 17, fontWeight: "bold",}}><FontAwesomeIcon icon={faLock}></FontAwesomeIcon> Промяна на парола</p>}>
