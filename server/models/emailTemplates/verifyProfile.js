...
const verifyProfileChangeEmail = (key) => {
  return `<p>Здравейте, <br> Вие посочихте, че искате да използвате този имейл занапред в платформата на AnimalAid! За да потвърдите профила си трябва да кликнете <a href="${BASE_URL}/verifyProfile?key=${key}">тук</a>.<br>Поздрави,<br>Екипът на Animal Aid</p>`;
};
module.exports = {
  verifyProfileUser,
  verifyProfileVet,
